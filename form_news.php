...
<section>
    <div class="container">
        <div id="more_info_content" class="box info flex">
            <form name="upload" action="download_img_news.php" method="POST" ENCTYPE="multipart/form-data">


                <div class="info_img info_box">
                    <?php
                    if($_SESSION['dowland_img_news']['status'] == 0 && $_SESSION['dowland_img_news']['status'] !== null)  {
