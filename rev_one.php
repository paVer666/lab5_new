...
if($_SESSION['pointer_review']['name'] == NULL){
        ...
        <div class="container">
                ...
                <div class="library">
                    ...
                    <div class="film_content_place">
                        <?php
                        print ('
                        <img class="library_poster" src="'.$_SESSION['pointer_review']['picture'].'" alt="">
                        <div class="library_content_place_text">
                            <p class="library_content_place_name_text large_text">'.$_SESSION['pointer_review']['name'].'</p>
                            <p class="library_text middle_text">Описание :</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['text_preview'].'</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['text_main'].'</p>
                            <p class="library_text middle_text">Фильм :</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['film'].'</p>
                            <p class="library_text middle_text">Автор :</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['nick'].'</p>
                            <p class="library_text middle_text">Дата создания :</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['date'].'</p>
                            <p class="library_text middle_text">Просмотров :</p>
                            <p class="roboto library_text review gray_text">'.$_SESSION['pointer_review']['visit'].'</p>
                        </div>
                        ');
                        ?>
    ...
    <section id="comment" style="display: flex;">
        <div class="container">
                ...
                <div   class="library">
                    ...
                    <?php
                    $comment = conectDB_comment($_SESSION['pointer_review']['id']);
                ...
                <div class="library_content_place">
                    <div class="library_content_place_text">
                        ...
                        <div class="accaunt_container_info">
                            ...
                            <button class="info_btn" onclick="scripts.js/insert_comment()" style="margin-bottom: 50px;">Отправить</button>
                        </div>
                    </div>
                </div>
            </div>
